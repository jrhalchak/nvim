...
local servers = { 'lua_ls', 'bashls', 'pyright', 'clangd', 'html', 'cssls', --[[ 'tsserver',  ]]'vimls' }
...
local ts_base = lsp_settings.Typescript
for k,v in pairs(config_base) do ts_base.server[k] = v end

typescript.setup(ts_base)
...
for _, lsp in ipairs(servers) do
  ...
  if lsp == 'lua_ls' then
    ...
    config_base.settings.Lua = lsp_settings.Lua
  end
